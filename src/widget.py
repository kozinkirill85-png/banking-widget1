...
def mask_account_card(info: str) -> str:
    ...
    Args:
        info (str): Строка, содержащая тип (например, "Visa Classic", "Счет") и номер.

    Returns:
        str: Строка с замаскированным номером.

    Raises:
        ValueError: При некорректном формате строки или номера.
    """
...
def get_date(date_string: str) -> str:
    ...
    Args:
        date_string (str): Дата в формате ISO (YYYY-MM-DDTHH:MM:SS.ffffff).
    ...
    """
    try:
        clean_date_str = date_string.replace("Z", "+00:00").split(".")[0]
